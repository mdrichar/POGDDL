...
void assignGame(int gameid, bool& alwaysCheckPayoffs, string& domainString, string& problemString) {
	...
	case 20:
		...
		break;
	case 21:
		domainString = "../domains/LongBattleship.pog";
		problemString = "../problems/Battleship/battleship-2.4.pog";
...
int main(int argc, char * argv[]) {
	...
	//RackoWorldStateFormatter formatter;
	//RackoWorldStateFormatter formatter(10,60);
	//BattleshipWorldStateFormatter formatter;
