#ifndef __ISCONTROLLER
#define __ISCONTROLLER
...
class InitialStateVisitController : public VisitController {
public:
  ...
  //VecSetInt opsEffectsOf;
	...
	//const StringToInt& objectTbl;
        ...
        VAL::Processor* proc;
	WorldState& ws;
	InitialStateVisitController(Processor* p_); // : proc(p_), ws(proc->worldState) {}; 
	virtual ~InitialStateVisitController() {};
